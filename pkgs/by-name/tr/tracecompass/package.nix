...
stdenv.mkDerivation (finalAttrs: rec {
  ...
  src = fetchurl {
    ...
    sha256 = "sha256-QNJAJkgpV8v94IJx/jnQQ5HhX0kuASET3ywa/nfhsEs=";
  };
  ...
  installPhase = ''
    ...
    patchelf --set-interpreter "$interpreter" $out/trace-compass/tracecompass
    ...
    makeWrapper $out/trace-compass/tracecompass $out/bin/tracecompass \
      ...
      --add-flags "-configuration \$HOME/.tracecompass/${version}/configuration"

    mkdir -p $out/share/applications
    cp ${desktopItem}/share/applications/* $out/share/applications

    install -Dm644 icon.xpm $out/share/pixmaps/tracecompass.xpm
    for size in 16 24 32 48 64 128 256; do
      install -Dm644 icon.xpm "$out/share/icons/hicolor/''${size}x''${size}/apps/tracecompass.xpm"
    done
  ...
  meta = with lib; {
    ...
    changelog = "https://download.eclipse.org/tracecompass/doc/stable/release-notes/TraceCompass-''${version}.html";
